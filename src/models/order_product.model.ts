...
export const createOrderProduct = async (order_product: OrderProduct): Promise<OrderProduct> => {
  try {
...
export const updateOrderProduct = async (orderproduct: OrderProduct): Promise<OrderProduct> => {
  try {
...
export const getUserOrderProducts = async (user_id: number): Promise<OrderProduct[]> => {
  try {
